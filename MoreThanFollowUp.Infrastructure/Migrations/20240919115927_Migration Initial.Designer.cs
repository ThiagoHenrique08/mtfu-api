...
namespace MoreThanFollowUp.Infrastructure.Migrations
{
    ...
    [Migration("20240919115927_Migration Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoreThanFollowUp.Domain.Models.Squad", b =>
                {
                    b.Property<int>("SquadId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT");
            ...
            modelBuilder.Entity("MoreThanFollowUp.Domain.Entities.Projects.Project", b =>
                {
                    b.HasOne("MoreThanFollowUp.Domain.Models.Squad", "Squad")
                        .WithMany("Projects")
                        .HasForeignKey("SquadId")
                        .HasPrincipalKey("EnterpriseId")
                        .OnDelete(DeleteBehavior.Cascade);
