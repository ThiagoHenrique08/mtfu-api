...
namespace MoreThanFollowUp.Infrastructure.Migrations
{
    ...
    [Migration("20241002231038_Adicionando usuarios a sprint")]
    partial class Adicionandousuariosasprint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MoreThanFollowUp.Domain.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("MoreThanFollowUp.Domain.Entities.Projects.Sprint", null)
                        .WithMany("Users")
